  ...
  return (
    <Container>
      ...
      <main>
        ...
        <div>
          <Tag title="Ficção Científica" color={({ theme }) => theme.COLORS.PINK_900} />
          <Tag title="Drama" color={({ theme }) => theme.COLORS.PINK_900} />
          <Tag title="Família" color={({ theme }) => theme.COLORS.PINK_900} />
        </div>
        ...
        <p>
          ...
          codificadas através de radiação gravitacional, deixando coordenadas em binário que os levam até 
          uma instalação secreta da NASA liderada pelo professor John Brand. O cientista revela que um buraco 
